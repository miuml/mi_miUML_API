create or replace function miclass.method_class_migrate_nonspec(
	-- Existing
...
$$
--
-- Migrates this Class from Specialized to Non Specialized.
-- 
...
begin
	...
	delete from specialized_class where
		name = self.name and domain = self.domain;

	-- New Specialized instance
	insert into non_specialized_class( name, domain ) values( self.name, self.domain );
end
$$
language plpgsql;
