create or replace function mipoly.method_del_event_delete_all_via_gen(
	-- ID
...
$$
--
-- Method: Delegated Event.Delete all via generalization( generalization )
--
-- Deletes all descendant Delegated and Effective Events via the supplied
-- gen rnum, leaving this Delegation Event intact if it still delegates via another
-- Generalization.  (If it is defined on a Class playing at least one remaining
-- Superclass role).
--
-- 
