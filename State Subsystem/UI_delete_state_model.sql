create or replace function mistate.UI_delete_state_model(
	-- Existing
...
$$
--
-- UI: Delete state model
--
-- Deletes the specified State Model
--
--
...
begin
	...
	-- Call the app
	perform method_state_model_delete( v_sm_name, v_sm_type, p_domain, sm_err_name );
end
$$
language plpgsql;
