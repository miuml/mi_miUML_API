create or replace function midom.UI_set_subsystem_next_rnum(
	-- Existing
...
$$
--
-- Resets the Rnum sequence generator so that it starts from a different value
...
begin
	...
	-- Invoke function
	perform method_subsystem_set_next_rnum( p_name, p_domain, v_next_value );
end
$$
language plpgsql;
