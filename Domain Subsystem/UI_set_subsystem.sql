create or replace function midom.UI_set_subsystem(
	-- Focus
	p_domain  mi.name,
	p_name    mi.name,
	-- Modify
...
$$
--
-- UI Bridge: Sets Subsystem attributes
-- ++ -
-- ==
--
...
--
declare
	v_new_alias  subsystem.alias%type;
	v_new_name   subsystem.name%type;
begin
	-- Validate attributes
	begin
